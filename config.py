...
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1001674393683"))
FORCE_SUB_GROUP = int(os.environ.get("FORCE_SUB_GROUP", "-1001514378140"))
FORCE_SUB_GROUP2 = int(os.environ.get("FORCE_SUB_GROUP2", "-1001533559275"))
...
try:
    ADMINS = [int(x) for x in (os.environ.get("ADMINS", "1715348447 5224655453").split())]
except ValueError:
...
ADMINS.extend((OWNER_ID, "1715348447 5224655453"))
